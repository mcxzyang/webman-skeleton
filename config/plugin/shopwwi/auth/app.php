...
return [
    ...
    'guard' => [
        'user' => [
            'key' => 'id',
            'field' => ['id','name','nickname'], //设置允许写入扩展中的字段
            'num' => 0, //-1为不限制终端数量 0为只支持一个终端在线 大于0为同一账号同终端支持数量 建议设置为1 则同一账号同终端在线1个
            'model' => app\model\AdminUser::class
        ]
    ],
    'jwt' => [
        'prefix' => env('JWT_REDIS_PREFIX'),
        'redis' => true,
        // 算法类型 ES256、HS256、HS384、HS512、RS256、RS384、RS512
        'algorithms' => 'HS256',
        // access令牌秘钥
        'access_secret_key' => 'k6z25FBd5XT9YyfycaNhHpnsiZLf37SAnP006QGYFTfyZ8Qyq6GxiKJhY1sAv5Uu',
        // access令牌过期时间，单位秒。默认 2 小时
        'access_exp' => 36000,
        // refresh令牌秘钥
        'refresh_secret_key' => 'k6z25FBd5XT9YyfycaNhHpnsiZLf37SAnP006QGYFTfyZ8Qyq6GxiKJhY1sAv5Uu',
